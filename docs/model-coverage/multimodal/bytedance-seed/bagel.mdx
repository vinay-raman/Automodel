...
|---|---|---|
| [bagel_pretrain.yaml](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/multimodal_pretrain/bagel/bagel_pretrain.yaml) | BAGEL-style packed multimodal data | Joint text-understanding and image-generation pretraining |
| [bagel_sft.yaml](https://github.com/NVIDIA-NeMo/Automodel/blob/main/examples/multimodal_finetune/bagel/bagel_sft.yaml) | BAGEL-style packed multimodal data | Joint understanding + generation fine-tuning |
