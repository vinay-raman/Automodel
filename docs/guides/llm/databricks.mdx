...
<Frame caption="Single GPU utilization of approximately 95% during model training.">
  <img src="./databricks-gpu-metrics-single.png" alt="Single GPU utilization of approximately 95% during model training." />
</Frame>
...
<Frame caption="Multi-GPU, single-node utilization of approximately 95% during model training.">
  <img src="./databricks-gpu-metrics-multi.png" alt="Multi-GPU, single-node utilization of approximately 95% during model training." />
</Frame>
